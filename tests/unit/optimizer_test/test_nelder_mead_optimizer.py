...
class TestNelderMeadOptimizer(BaseTest):
    ...
    def test_generate_initial_parameter(self):
        expected = [
            {'name': 'x1', 'type': 'uniform_float', 'value': 0.74, 'out_of_boundary': False},
            {'name': 'x2', 'type': 'uniform_float', 'value': 2.98, 'out_of_boundary': False},
            {'name': 'x3', 'type': 'uniform_float', 'value': 3.62, 'out_of_boundary': False},
            {'name': 'x4', 'type': 'uniform_float', 'value': 0.9, 'out_of_boundary': False},
            {'name': 'x5', 'type': 'uniform_float', 'value': 1.99, 'out_of_boundary': False},
            {'name': 'x6', 'type': 'uniform_float', 'value': -2.78, 'out_of_boundary': False},
            {'name': 'x7', 'type': 'uniform_float', 'value': 1.0, 'out_of_boundary': False},
            {'name': 'x8', 'type': 'uniform_float', 'value': 4.97, 'out_of_boundary': False},
            {'name': 'x9', 'type': 'uniform_float', 'value': 1.98, 'out_of_boundary': False},
            {'name': 'x10', 'type': 'uniform_float', 'value': 4.03, 'out_of_boundary': False}
        ]
